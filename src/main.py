...
class WhaleMonitor:
    ...
    def __init__(self) -> None:
        ...
        self._cg_ws: CoinGlassWSClient | None = None

    async def _on_alert(self, order: WhaleOrder, matched_rules: list[str]) -> None:
    ...
    async def start(self) -> None:
        logger.info("=" * 60)
        logger.info("  BTC Whale Order Monitor v1.0.0")
